...
public class BuildVars {
    ...
    public static final int BUILD_VERSION = BuildConfig.OFFICIAL_APP_VERSION_CODE;
    public static final String BUILD_VERSION_STRING = BuildConfig.OFFICIAL_APP_VERSION_NAME;
